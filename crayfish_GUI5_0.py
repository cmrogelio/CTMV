...
class App:
    ...
    def rest(self):
         if(self.prueba<self.test_no.get()):
              ...
              if(self.delta_time>=self.epoch_time):
                   ...
                   self.window.after(15, self.rest)
         else:
               self.new_test()
    ...
    def height(self):
        ...
        self.m_height.geometry("200x130")
    ...
    def test(self):
        if self.video!=1:
             ...
             if imagen1 is not None:
                  ...
                  self.obj1_x,self.obj1_y,self.obj2_x,self.obj2_y,self.obj3_x,self.obj3_y,self.x2,self.y2,self.c,self.fin = ml.mon_cal(imagen,self.thoras,self.tminutos,self.tseg,self.obj1_x,self.obj1_y,self.obj2_x,self.obj2_y,self.obj3_x,self.obj3_y,self.x2,self.y2,self.rute,self.dif,self.area,self.umbral,self.aper,self.cier)
