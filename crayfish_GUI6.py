        ...
        if self.video!=1:
             ...
             if imagen1 is not None:
                  ...
                  if self.lim_cont>0:
                       ...
                       self.z1obj1_x,self.z1obj1_y,self.z1obj2_x,self.z1obj2_y,self.z1obj3_x,self.z1obj3_y,self.z1obj4_x,self.z1obj4_y,self.z1x2,self.z1y2,self.cz1,self.fin = ml.mon_cal(self.zone1,self.thoras,self.tminutos,self.tseg,self.z1obj1_x,self.z1obj1_y,self.z1obj2_x,self.z1obj2_y,self.z1obj3_x,self.z1obj3_y,self.z1obj4_x,self.z1obj4_y,self.z1x2,self.z1y2,str(self.rute)+"/z1_",self.dif,self.area,self.umbral,self.aper,self.cier)
                  if self.lim_cont>1:
                       self.zone2 = self.dis_imagen[self.ly[2]:self.ly[3], self.lx[2]:self.lx[3]]
                       self.z2obj1_x,self.z2obj1_y,self.z2obj2_x,self.z2obj2_y,self.z2obj3_x,self.z2obj3_y,self.z2obj4_x,self.z2obj4_y,self.z2x2,self.z2y2,self.cz2,self.fin = ml.mon_cal(self.zone2,self.thoras,self.tminutos,self.tseg,self.z2obj1_x,self.z2obj1_y,self.z2obj2_x,self.z2obj2_y,self.z2obj3_x,self.z2obj3_y,self.z2obj4_x,self.z2obj4_y,self.z2x2,self.z2y2,str(self.rute)+"/z2_",self.dif,self.area,self.umbral,self.aper,self.cier)
                  if self.lim_cont>2:
                       self.zone3 = self.dis_imagen[self.ly[4]:self.ly[5], self.lx[4]:self.lx[5]]
                       self.z3obj1_x,self.z3obj1_y,self.z3obj2_x,self.z3obj2_y,self.z3obj3_x,self.z3obj3_y,self.z3obj4_x,self.z3obj4_y,self.z3x2,self.z3y2,self.cz3,self.fin = ml.mon_cal(self.zone3,self.thoras,self.tminutos,self.tseg,self.z3obj1_x,self.z3obj1_y,self.z3obj2_x,self.z3obj2_y,self.z3obj3_x,self.z3obj3_y,self.z3obj4_x,self.z3obj4_y,self.z3x2,self.z3y2,str(self.rute)+"/z3_",self.dif,self.area,self.umbral,self.aper,self.cier)
                  if self.lim_cont>3:
                       self.zone4 = self.dis_imagen[self.ly[6]:self.ly[7], self.lx[6]:self.lx[7]]
                       self.z4obj1_x,self.z4obj1_y,self.z4obj2_x,self.z4obj2_y,self.z4obj3_x,self.z4obj3_y,self.z4obj4_x,self.z4obj4_y,self.z4x2,self.z4y2,self.cz4,self.fin = ml.mon_cal(self.zone4,self.thoras,self.tminutos,self.tseg,self.z4obj1_x,self.z4obj1_y,self.z4obj2_x,self.z4obj2_y,self.z4obj3_x,self.z4obj3_y,self.z4obj4_x,self.z4obj4_y,self.z4x2,self.z4y2,str(self.rute)+"/z4_",self.dif,self.area,self.umbral,self.aper,self.cier)          
...
#Cam(Tk(), "Camera")
App(Tk(), "Crayﬁsh-Tracking Motion Vision ver.2.2.3")
